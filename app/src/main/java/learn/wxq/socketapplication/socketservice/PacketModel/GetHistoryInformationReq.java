 ...
 */
public class GetHistoryInformationReq extends Packet{
    protected static final String CMD = "GetHistoryInformation";
    protected static int actiontype=1;
    protected String datastr="";
    public GetHistoryInformationReq( String uid, String toUid,String data) {
